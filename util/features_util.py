...
def preprocessing_pipeline(x: np.ndarray, where: Union[str, List[str]], feature_index: Dict[str, int]) -> np.ndarray:
    return align_nans(map_values(x, where, feature_index), where, feature_index)
